...
$(function() {
    ...
    $('.list_van li').click(function(){
        ...
        $('.warp_list .list').addClass('current').siblings().removeClass('current')
    })
    /*table 切换 end*/
    ...
    $('.pro_pic .pic>ul>li').first().clone().appendTo('.pro_pic .pic>ul');
    /*拷贝一份Li*/
    /*ul的width 自动适应 li*/
   ...
   /* 评论事件 end*/
    ...
    $('.pic_btn .meal').click(function(){
        ...
        var strone='<li dataindex="'+item+'"><ul><li><label class="current" onclick="check(this)"><input type="hidden"></label>' +
            ...
            '</li><li><span>套餐内型：三件套</span></li><li><s class="old">'+'￥'+olD+'</s><br/><span class="print">'+'￥'+total+'</span>' +
