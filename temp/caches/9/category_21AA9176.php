<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:47:"D:/wamp/www/mingyou/themes/mingyou/category.dwt";i:1;s:59:"D:/wamp/www/mingyou/themes/mingyou/library/page_header1.lbi";i:2;s:59:"D:/wamp/www/mingyou/themes/mingyou/library/page_footer1.lbi";}s:7:"expires";i:1500978748;s:8:"maketime";i:1500975148;}<!DOCTYPE html>
<html lang="en">
<head>
    ...
    function checkSearchForm()
    {
        ...
        <div class="van clearfix">
            ...
            <ul class="van_list">
                ...
                <li  class="current"><a href="category.php?id=685">水壶</a></li>
            ...
            <div class="menu">
                <ul>
						...
						<dt><a href="category.php?id=685">小僵尸</a></dt>
						...
						<dt><a href="category.php?id=686">大僵尸</a></dt>
...
<div class="content">
    ...
    <div class="top_list_noe clearfix">
        ...
        <ul>
				 <li class="current">
		 <a href="category.php?id=685&amp;price_min=0&amp;price_max=0">全部</a>
		 </li>
				 <li >
		 <a href="category.php?id=685&amp;brand=2&amp;price_min=0&amp;price_max=0">APPLE</a>
		 </li>
				 <li >
		 <a href="category.php?id=685&amp;brand=5&amp;price_min=0&amp;price_max=0">漫步者</a>
		 </li>
				 <li >
		 <a href="category.php?id=685&amp;brand=7&amp;price_min=0&amp;price_max=0">美的</a>
		 </li>
        ...
        <h3>精品分类</h3>
        <ul>
		            <li  class="current" ><a href="category.php?id=685&amp;price_min=0&amp;price_max=0">全部</a></li>
		            <li ><a href="category.php?id=685&amp;price_min=0&amp;price_max=0&amp;filter_attr=3782">浴用电器</a></li>
		            <li ><a href="category.php?id=685&amp;price_min=0&amp;price_max=0&amp;filter_attr=3783">生活电器</a></li>
    ...
    <div class="table_text">
        <ul class="clearfix">
            <li>
                ...
                <!-- <a href="###">人气</a> -->
<a href="category.php?category=685&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=is_num&order=DESC#goods_list">人气</a>				
				
				
                <!-- <a href="###">新品</a> -->
<a href="category.php?category=685&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list">新品</a>
                <a href="###">销量</a>
                <!-- <a href="###">价格</a> -->
<a href="category.php?category=685&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">价格</a>
	...
	<input type="hidden" name="category" value="685" />
    ...
    <div class="pic_page">
        <ul>
            <li><a href="">上一页</a></li>
		            ...
		            <li class="current"><a href="category.php?id=685&amp;price_min=0&amp;price_max=0&amp;page=1&amp;sort=goods_id&amp;order=DESC">1</a></li>
					
				<li><a href="category.php?id=685&amp;price_min=0&amp;price_max=0&amp;page=2&amp;sort=goods_id&amp;order=DESC">2</a></li>
					
				<li><a href="category.php?id=685&amp;price_min=0&amp;price_max=0&amp;page=3&amp;sort=goods_id&amp;order=DESC">3</a></li>
					
          
            <!-- <li></li> -->
            <li><a href="category.php?id=685&amp;price_min=0&amp;price_max=0&amp;page=2&amp;sort=goods_id&amp;order=DESC">下一页</a></li>
        </ul>
    </div>
</div>
<div class="footer">
